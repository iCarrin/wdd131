...
function togglePaymentDetails(e) {
  ...
  const creditCardContainer = document.getElementById("card_container");
  const paypalContainer = document.getElementById("paypal_container");
  ...
  theForm.card_num.required = false
  theForm.pal_name.required = false

  // Show the container based on the selected payment method, and add the required attribute back.
  if (theForm.payment.value === "visa" || theForm.payment.value === "master_card") {
    creditCardContainer.classList.remove("hide");
    theForm.card_num.required = true;
  } else if (theForm.payment.value === "paypal") {
    paypalContainer.classList.remove("hide");
    theForm.pal_name.required = true;
  }
}
